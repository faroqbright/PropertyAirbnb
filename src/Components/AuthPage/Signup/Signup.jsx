          ...
          <div className="bg-white rounded-xl border-[1.5px] border-gray-200 w-3/4 lg:w-1/2 lg:px-14 px-5 flex flex-col py-20">
            ...
            <div className="mt-10">
              ...
              <div className="flex flex-col lg:flex-row justify-between mt-10 gap-4">
                <button className="flex gap-2 border-[1.5px] rounded-full mt-5 lg:mt-0 py-2 px-5 text-gray-500">
                  <Facebook className="text-white bg-blue-600 rounded-full py-1 px-1" />{" "}
