  ...
  return (
    <div className="relative">
      ...
      <div className="absolute inset-x-0 bottom-0 flex justify-center">
        <div className="sm:w-[70%] w-[95%] max-w-7xl p-3 bg-purplebutton rounded-lg lg:rounded-full flex flex-wrap lg:flex-nowrap items-center gap-4 mb-4 relative">
          ...
          <div className="flex-1 min-w-0 relative">
            ...
            <input
              ...
              className="text-sm text-gray-200 placeholder:text-slate-200 text-[12px] sm:text-[13px] bg-transparent border-none outline-none w-full cursor-pointer"
            />
          ...
          <div className="flex-1 min-w-0 relative">
            ...
            {showDropdown && (
              <div
                ref={dropdownRef}
                className="absolute z-50 mt-5 scrollbar-hide -ml-14 sm:-ml-0 w-44 sm:w-48 bg-white shadow-lg rounded-lg max-h-48 overflow-auto"
              >
                <div className="p-3">
