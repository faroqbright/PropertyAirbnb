  ...
  return (
    <div className="bg-[#FAFAFA] p-6 my-12 text-center">
      ...
      <div className="flex justify-center items-center my-10">
        <div className="grid min-[400px]:grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-4">
          {icons.map((icon, index) => (
            <div
              key={index}
              className="flex items-center justify-center border-[1px] border-gray-300 p-4 rounded-full px-4 py-2"
            >
